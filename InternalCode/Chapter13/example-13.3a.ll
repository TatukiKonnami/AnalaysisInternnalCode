; ModuleID = 'ClangNoteBook/Chapter13/example-13.3a.c'
source_filename = "ClangNoteBook/Chapter13/example-13.3a.c"
target datalayout = "e-m:o-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-apple-macosx10.13.0"

@main.x = private unnamed_addr constant [7 x i32] [i32 3, i32 1, i32 4, i32 1, i32 5, i32 9, i32 2], align 16
@.str = private unnamed_addr constant [16 x i8] c"\E6\9C\80\E5\A4\A7\E5\80\A4\E3\81\AF%d\0A\00", align 1
...
; <label>:29:                                     ; preds = %9
  ...
  %31 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str, i32 0, i32 0), i32 %30)
  ret i32 0
}
