; ModuleID = 'ClangNoteBook/Chapter13/example-13.8.c'
source_filename = "ClangNoteBook/Chapter13/example-13.8.c"
target datalayout = "e-m:o-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-apple-macosx10.13.0"

@main.x = private unnamed_addr constant [20 x i32] [i32 51, i32 4, i32 8, i32 41, i32 59, i32 6, i32 65, i32 9, i32 5, i32 62, i32 78, i32 93, i32 23, i32 84, i32 3, i32 63, i32 33, i32 7, i32 2, i32 40], align 16
@.str = private unnamed_addr constant [14 x i8] c"\E3\82\BD\E3\83\BC\E3\83\88\E5\89\8D\0A\00", align 1
@.str.1 = private unnamed_addr constant [4 x i8] c"%d \00", align 1
@.str.2 = private unnamed_addr constant [16 x i8] c"\0A \E3\82\BD\E3\83\BC\E3\83\88\E5\BE\8C\0A\00", align 1
...
define i32 @main() #0 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %8, i8* bitcast ([20 x i32]* @main.x to i8*), i64 80, i32 16, i1 false)
...
; <label>:73:                                     ; preds = %24
  %74 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.2, i32 0, i32 0))
  store i32 0, i32* %3, align 4
  br label %75
