; ModuleID = 'ClangNoteBook/Chapter13/example-13.1.c'
source_filename = "ClangNoteBook/Chapter13/example-13.1.c"
...
@.str.3 = private unnamed_addr constant [11 x i8] c"a=%d b=%d\0A\00", align 1
...
define i32 @main() #0 {
  ...
  %11 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.3, i32 0, i32 0), i32 %9, i32 %10)
  ...
  %17 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.3, i32 0, i32 0), i32 %15, i32 %16)
  ret i32 0
}
