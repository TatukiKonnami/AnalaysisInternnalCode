; ModuleID = 'ClangNoteBook/Chapter7/example-7.7.c'
source_filename = "ClangNoteBook/Chapter7/example-7.7.c"
...
define i32 @main() #0 {
  ...
  %3 = call i32 @puts(i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str, i32 0, i32 0))
