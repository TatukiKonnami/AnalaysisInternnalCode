; ModuleID = 'ClangNoteBook/Chapter7/example-7.3.c'
source_filename = "ClangNoteBook/Chapter7/example-7.3.c"
...
define i32 @main() #0 {
  ...
  %12 = getelementptr inbounds [6 x i8], [6 x i8]* %2, i32 0, i32 0
